...
HD_PWD='/home/tingyuan/Documents/zedboard-base-master/Vivado/zedboard_base/zedboard_base.runs/zedboard_base_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zedboard_base_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zedboard_base_axi_timer_0_0.tcl
