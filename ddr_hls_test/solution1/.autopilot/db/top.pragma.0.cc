...
#pragma HLS INTERFACE m_axi depth=1 port=&saMaster offset=slave max_write_burst_length=4 max_read_burst_length=4 num_read_outstanding=1 num_write_outstanding=1
